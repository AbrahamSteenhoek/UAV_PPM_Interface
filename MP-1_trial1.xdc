...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {PPM_OUT}];  # "JA1" # PPM_OUT TO RC TRANSMITTER
set_property PACKAGE_PIN AA11 [get_ports {PPM_CAP_PS[0]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {PPM_CAP_PS[1]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {PPM_CAP_WRITE_EN}];  # "JA4"
set_property PACKAGE_PIN AB10 [get_ports {PPM_IN}];  # "JA8"
set_property PACKAGE_PIN AB11 [get_ports {PPM_CAP_CUR_CH[0]}];  # "JA7"
set_property PACKAGE_PIN AB9  [get_ports {PPM_CAP_CUR_CH[1]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {PPM_CAP_CUR_CH[2]}];  # "JA10"
...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {v_pad[1]}];  # "JC1_N"  "Virtual Switch 7"
set_property PACKAGE_PIN AB7 [get_ports {v_pad[4]}];  # "JC1_P"  "Virtual Switch 6"
set_property PACKAGE_PIN AA4 [get_ports {v_pad[3]}];  # "JC2_N"  "Virtual Switch 5"
set_property PACKAGE_PIN Y4  [get_ports {v_pad[2]}];  # "JC2_P"  "Virtual Switch 4"
#set_property PACKAGE_PIN T6  [get_ports {PPM_CAP_RESET}];  # "JC3_N"  "Virtual Switch 3"  
set_property PACKAGE_PIN R6  [get_ports {v_pad[0]}];  # "JC3_P"  "Virtual Switch 2"
set_property PACKAGE_PIN U4  [get_ports {PPM_IN_2}];  # "JC4_N"  "Virtual Switch 1" -- VIRTUAL PPM INPUT SIG
