...
#
# MP-1_Vivado_trial1.tcl: Tcl script for re-creating project 'MP-1_Vivado_trial1'
#
# Generated by Vivado on Wed Mar 03 22:31:45 -0600 2021
...
#
# 1. This project restoration tcl script (MP-1_Vivado_trial1.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "U:/CPRE_488/MP-1/MP-1_Vivado_trial1/MP-1_Vivado_trial1.srcs/sources_1/bd/UAV_Control/hdl/UAV_Control_wrapper.vhd"
#    "U:/CPRE_488/MP-1/MP-1_Vivado_trial1/MP-1_trial1.xdc"
#
...
set _xil_proj_name_ "MP-1_Vivado_trial1"
...
set script_file "MP-1_Vivado_trial1.tcl"
...
set orig_proj_dir "U:/CPRE_488/MP-1/MP-1_Vivado_trial1"
...
set_property -name "ip_output_repo" -value "U:/CPRE_488/MP-1/${_xil_proj_name_}/${_xil_proj_name_}.cache/ip" -objects $obj
...
set_property -name "sim.central_dir" -value "U:/CPRE_488/MP-1/${_xil_proj_name_}/${_xil_proj_name_}.ip_user_files" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "U:/CPRE_488/MP-1/ip_repo/axi_ppm_32R_1.0 U:/CPRE_488/MP-1/ip_repo/LED_setter_1.0 U:/CPRE_488/MP-1/ip_repo/axi_ppm_1.0" $obj
...
set file "hdl/UAV_Control_wrapper.vhd"
...
set_property -name "top" -value "UAV_Control_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/U:/CPRE_488/MP-1/MP-1_Vivado_trial1/MP-1_trial1.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "MP-1_Vivado_trial1/MP-1_trial1.xdc"
...
# Proc to create BD UAV_Control
proc cr_bd_UAV_Control { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name UAV_Control
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  iastate.edu:user:LED_setter:1.0\
  iastate.edu:user:axi_ppm_32R:1.0\
  ...
  # Create ports
  set PPM_CAP_CUR_CH [ create_bd_port -dir O -from 2 -to 0 PPM_CAP_CUR_CH ]
  set PPM_CAP_PS [ create_bd_port -dir O -from 1 -to 0 PPM_CAP_PS ]
  set PPM_CAP_WRITE_EN [ create_bd_port -dir O PPM_CAP_WRITE_EN ]
  set PPM_IN [ create_bd_port -dir I PPM_IN ]
  set PPM_IN_2 [ create_bd_port -dir I PPM_IN_2 ]
  set PPM_OUT [ create_bd_port -dir O PPM_OUT ]
  set leds [ create_bd_port -dir O -from 7 -to 0 leds ]
  set v_pad [ create_bd_port -dir I -from 4 -to 0 v_pad ]
  set v_sw [ create_bd_port -dir I -from 7 -to 0 v_sw ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins LED_setter_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_ppm_32R_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net BTNS_IN_0_1 [get_bd_ports v_pad] [get_bd_pins LED_setter_0/BTNS_IN]
  connect_bd_net -net LED_setter_0_LEDS_OUT [get_bd_ports leds] [get_bd_pins LED_setter_0/LEDS_OUT]
  connect_bd_net -net PPM_IN_1 [get_bd_ports PPM_IN] [get_bd_pins axi_ppm_32R_0/PPM_IN]
  connect_bd_net -net PPM_IN_2_1 [get_bd_ports PPM_IN_2] [get_bd_pins axi_ppm_32R_0/PPM_IN_2]
  connect_bd_net -net SWS_IN_0_1 [get_bd_ports v_sw] [get_bd_pins LED_setter_0/SWS_IN]
  connect_bd_net -net axi_ppm_32R_0_PPM_CAP_CUR_CH [get_bd_ports PPM_CAP_CUR_CH] [get_bd_pins axi_ppm_32R_0/PPM_CAP_CUR_CH]
  connect_bd_net -net axi_ppm_32R_0_PPM_CAP_CUR_STATE [get_bd_ports PPM_CAP_PS] [get_bd_pins axi_ppm_32R_0/PPM_CAP_CUR_STATE]
  connect_bd_net -net axi_ppm_32R_0_PPM_CAP_WRITE_EN [get_bd_ports PPM_CAP_WRITE_EN] [get_bd_pins axi_ppm_32R_0/PPM_CAP_WRITE_EN]
  connect_bd_net -net axi_ppm_32R_0_PPM_out [get_bd_ports PPM_OUT] [get_bd_pins axi_ppm_32R_0/PPM_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LED_setter_0/s00_axi_aclk] [get_bd_pins axi_ppm_32R_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins LED_setter_0/s00_axi_aresetn] [get_bd_pins axi_ppm_32R_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LED_setter_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_ppm_32R_0/S00_AXI/S00_AXI_reg] -force
...
# End of cr_bd_UAV_Control()
cr_bd_UAV_Control ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files UAV_Control.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files UAV_Control.bd ] 
set_property IS_ENABLED "1" [get_files UAV_Control.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files UAV_Control.bd ] 
set_property IS_LOCKED "0" [get_files UAV_Control.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files UAV_Control.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files UAV_Control.bd ] 
set_property PFM_NAME "" [get_files UAV_Control.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files UAV_Control.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files UAV_Control.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files UAV_Control.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files UAV_Control.bd ] 
set_property USED_IN_SIMULATION "1" [get_files UAV_Control.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files UAV_Control.bd ] 
