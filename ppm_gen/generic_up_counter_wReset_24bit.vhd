...
entity frame_up_counter_wReset_24bit is
	port(clk : in std_logic;
		reset : in std_logic;
		enable : in std_logic;
		count_value : in std_logic_vector(24-1 downto 0); 
...
architecture dataflow of frame_up_counter_wReset_24bit is
	-- signal count_value_store : std_logic_vector(24-1 downto 0) := 0;
	signal count_s : std_logic_vector(24-1 downto 0);
begin
	-- process( count_value )
	-- begin
	-- 	if ( count_value != count_value_store )
	-- 		count_s <= x"000000";
	-- 		count_value_store <= count_value;
	-- 	end if;
    -- end process;
